...
class DeliveryPerson(models.Model):
    ...
    emergency_contact = models.CharField(max_length=15, help_text="Contact number for emergency cases")
    ...
    vehicle_color = models.CharField(max_length=30, blank=True, null=True, default="black", help_text="color of the vehicle")
    ...
    def clean(self):
        ...
        if self.dob > (today-timezone.timedelta(days=18*365)):
            raise ValidationError("Deliver person must be atleast 18 years old.")
        ...
        if self.driving_license and self.driving_license.size > 2*1024*1024:
            raise ValidationError("Driving license image file size must be less than 2 MB")
